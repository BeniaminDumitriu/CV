            ...
            <div className="max-w-6xl mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <motion.div
                    ...
                    className={`bg-gradient-to-br ${project.color}/10 p-6 rounded-xl border border-white/10 hover:border-white/20 transition-all cursor-pointer`}
                  >
      ...
      {!isLoading && currentSection === 'game' && (
        <div className="relative">
          ...
          <button
            ...
            className="fixed top-4 flex items-center  left-4 z-50 px-6 py-3 bg-black backdrop-blur-md border border-white/20 
